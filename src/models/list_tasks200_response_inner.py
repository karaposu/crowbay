...
class ListTasks200ResponseInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListTasks200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ListTasks200ResponseInner from a dict"""
        if obj is None:
            return None
