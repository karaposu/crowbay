...
class ListParticipatedTasks200ResponseInner(BaseModel):
    """
    ListParticipatedTasks200ResponseInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["task_id", "desc", "you_earn", "status", "partition_deadline", "submission_deadline", "category", "bay_review"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListParticipatedTasks200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ListParticipatedTasks200ResponseInner from a dict"""
        if obj is None:
            return None
